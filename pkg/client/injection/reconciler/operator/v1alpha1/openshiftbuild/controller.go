...
import (
	...
	openshiftbuild "github.com/tektoncd/operator/pkg/client/injection/informers/operator/v1alpha1/openshiftbuild"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "openshiftbuild-controller"
	defaultFinalizerName       = "openshiftbuilds.operator.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	openshiftbuildInformer := openshiftbuild.Get(ctx)

	lister := openshiftbuildInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "operator.tekton.dev.OpenShiftBuild"),
	)
